...
const Settings = () => {
    ...
    return (
        <>
            <Header />
            <div className="p-10 lg:grid grid-cols-2 dark:bg-gray-900 dark:text-gray-100 h-screen">
                <div className="mb-4">
                    ...
                    <form>
                        ...
                        <select name="category" id="category" onChange={handleCategoryChange} defaultValue={selectedCategory} className="border p-3 rounded-lg dark:border-none dark:bg-gray-600 dark:text-gray-100">
                ...
                <div>
                    ...
                    <form>
                        ...
                        <select name="country" id="country" onChange={handleCountryChange} defaultValue={selectedCountry} className="border p-3 rounded-lg dark:border-none dark:bg-gray-600 dark:text-gray-100">
